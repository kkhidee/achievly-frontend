...
type GoalsPublicDrawerWrapperProps = {
  goal: GoalDto;
  children: ReactNode;
...
const GoalsPublicDrawerWrapper = ({
  goal,
  children,
  isUpdatePending,
  onToggleType,
      ...
      <DrawerContent className="max-h-[90%] [&>div:first-child]:min-h-2">
        <div className="relative flex flex-col overflow-y-auto">
          <DrawerHeader>
            ...
            <DrawerDescription>
              Вы можете просмотреть информацию о цели и добавить её в свои цели
            </DrawerDescription>
          </DrawerHeader>
          <FormProvider {...form}>
...
export { GoalsPublicDrawerWrapper };
